<template>
	<div class="addEdit-block" :style='{"padding":"30px","margin":"0"}'>
		...
		>
			<template >
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="员工" prop="yonghuming">
					<el-input v-model="ruleForm.yonghuming" placeholder="员工" clearable  :readonly="ro.yonghuming"></el-input>
				</el-form-item>
